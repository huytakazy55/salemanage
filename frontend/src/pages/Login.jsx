...
export default function Login() {
    ...
    return (
        ...
        .login-input:focus { border-color:rgba(66,133,244,0.8); background:rgba(66,133,244,0.08); box-shadow:0 0 0 3px rgba(66,133,244,0.15); }
        .login-btn { width:100%; padding:13px; background:linear-gradient(135deg,#4285F4,#5A9CF5); color:#fff; border:none; border-radius:10px; font-size:15px; font-weight:600; cursor:pointer; transition:all .2s; font-family:inherit; display:flex; align-items:center; justify-content:center; gap:8px; }
        .login-btn:hover:not(:disabled) { background:linear-gradient(135deg,#3B6CE7,#4285F4); transform:translateY(-1px); box-shadow:0 8px 25px rgba(66,133,244,0.35); }
        .login-btn:disabled { opacity:0.6; cursor:not-allowed; transform:none; }
      `}</style>

            {/* Login card */}
            <div data-login-card style={{
                ...
                <div style={{ textAlign: 'center', marginBottom: 36 }}>
                    <div style={{ position: 'relative', display: 'inline-block', marginBottom: 16 }}>
                        ...
                        <div style={{
                            ...
                            <img src="/assets/capybara.png" alt="Capybara" style={{
